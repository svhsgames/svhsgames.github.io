		...
		return (
			<Card variant="outlined" className="flex-adaptive" style={ { ...style, overflow: "hidden", padding: 24, display: "flex" } } id={ id }>
				...
				<div style={ { width: "-webkit-fill-available", maxWidth: 390 } }>
					...
					<p>I see you're using an ad-blocker... {APP_MANIFEST.name} isn't free on my end and certainly isn't cheap to run and maintain. I use those ads to support future development and keep {APP_MANIFEST.name} free for everyone. It would mean a lot to us if this site got added to your ad-blocker whitelist. 💕</p>
				</div>
			</Card>
		);
	}
